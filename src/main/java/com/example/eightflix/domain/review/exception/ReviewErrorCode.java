package com.example.eightflix.domain.review.exception;
...
public enum ReviewErrorCode implements ErrorCode {
    ...
    EMPTY_REVIEW_CONTENT(HttpStatus.BAD_REQUEST.value(), "R001", "리뷰 내용은 비어 있을 수 없습니다."),
    INVALID_RATING_VALUE(HttpStatus.BAD_REQUEST.value(), "R002", "평점은 1점에서 5점 사이여야 합니다."),
