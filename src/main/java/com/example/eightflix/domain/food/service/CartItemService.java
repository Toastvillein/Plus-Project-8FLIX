...
import com.example.eightflix.domain.food.entity.CartItemUtil;
...
public class CartItemService {
	...
	private final CartItemUtil cartItemUtil;
	...
	public void foodPayment(Long cartId) {
		...
		for (CartItem cartItem : cartItems) {
			...
			cartItemUtil.decreaseQuantity(food, quantity);
		}
	...
	//
	// 		try {
	// 			isLocked = lock.tryLock(10,3, TimeUnit.SECONDS); // 최대 3초 기다리고 획득 후 5초뒤 자동 만료
	// 			if(!isLocked){
